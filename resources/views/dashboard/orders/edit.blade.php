            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('team.update', $team->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' id="name" name="name" rows="4" class="form-control" placeholder="name" value='{{ $team->name}}'>
                    </div>
                    
                    <div class="form-group">
                        <label for="name"> Bio</label>
                    <textarea  id="bio" name="bio" rows="4" class="form-control ckeditor" placeholder="name" >{{ $team->bio}}</textarea>
                    </div>
                   
                    <div class="form-group">
                        <label for="role"> Role</label>
                        <select class="form-control"  name='role'>
                      <option value='Translator' @if($team->role =='Translator') selected @endif >Translator</option>
                      <option value='Noter' @if($team->role =='Noter') selected @endif >Noter</option>
                    ...
                    <div class="form-group">
                        <input class="image_name" type="file" name="image" value="{{ $team->image }}">
                    </div>
                    <!-- <div class="form-group">
