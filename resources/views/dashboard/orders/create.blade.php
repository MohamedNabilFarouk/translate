            ...
            <div class="card card-form__body card-body">
                <form method="post" action="{{ route('team.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type='text' id="name" name="name" rows="4" class="form-control" placeholder="name" value='{{ old("name") }}'>
                    </div>

                    <div class="form-group">
                        <label for="name"> Bio</label>
                    <textarea  id="bio" name="bio" rows="4" class="form-control ckeditor" placeholder="name" >{{ old("bio") }}</textarea>
                    </div>
