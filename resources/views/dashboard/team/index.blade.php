                ...
                <div class="table-responsive" data-toggle="lists" data-lists-values='["js-lists-values-employee-name"]'>
                    ...
                    <table class="table mb-0 thead-border-top-0 table-striped">
                        ...
                        <tr>
                            ...
                            <td style="width: 30px;">
                                <div class="badge badge-soft-dark"> {{ $team->id }} </div>
                            </td>
                            ...
                            <td style="width:120px" class="text-center">
                                <img src="{{asset('images/'.$team->image) }}" style="width: 120px; height: 50px">
                            </td>

                            <td>
                                <a href="{{ route('team.edit', $team->id) }}" class="btn btn-sm btn-link">
